...
'''
This file enables your Python code to read from a serial port, which you
must insure is the SAME serial port that your Arduino writes to

The 'serial' module is part of the 'pyserial' package, which you can install
via pip:  'pip3 install pyserial'
'''
